var honeycomb = (function(){
	...
	var cellCentersOffsetsFromLeftEvenRows = [76, 209, 343, 475, 608, 741];
	...
	function createRoundPaginationControls(){
		...
		if(displayedPageNumber > 0){
			paginationPrevious.className = "hc-round-pagination hc-round-pagination-previous";
			paginationPrevious.addEventListener("click", decrementPage);
		}
		else{
			paginationPrevious.className = "hc-round-pagination hc-round-pagination-disabled hc-round-pagination-previous";
		}			

		var paginationNext = document.createElement("div");
		if(displayedPageNumber < totalPages - 1){
			paginationNext.className = "hc-round-pagination hc-round-pagination-next";
			paginationNext.addEventListener("click", incrementPage);
		}
		else{
			paginationNext.className = "hc-round-pagination hc-round-pagination-disabled hc-round-pagination-next";
		}
	...
	function createPaginationControls(){
		...
		var paginationPrevious = createPaginationControl();		
		if(displayedPageNumber > 0){
			paginationPrevious.addEventListener("click", decrementPage);
		}
		else{
			paginationPrevious.classList.add("hc-pagination-disabled");// = "hc-pagination hc-pagination-disabled hc-pagination-previous";
		}			

		var paginationNext = createNextPaginationControl();
		if(displayedPageNumber < totalPages - 1){
			paginationNext.addEventListener("click", incrementPage);
		}
		else{
			paginationNext.classList.add("hc-pagination-disabled");
		}
	...
	function createPaginationControl(){
		...
		cell.style.top = "140px";
		cell.style.left = "23px";	
